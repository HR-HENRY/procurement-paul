...
const mockOpportunities: Opportunity[] = [
  {
    ...
    url: "https://www.find-tender.service.gov.uk/Search/Results?q=gas+boiler+servicing+social+housing",
  ...
  },
  {
    ...
    url: "https://www.contractsfinder.service.gov.uk/Search/Results?q=gas+boiler+heating+servicing",
  ...
  },
  {
    ...
    published: "2026-03-01",
    source: "find-a-tender",
    url: "https://www.find-tender.service.gov.uk/Search/Results?q=central+heating+installation+new+build",
